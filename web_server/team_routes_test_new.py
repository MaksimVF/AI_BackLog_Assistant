...
@team_test_bp.route('/api/v1/team_test/members', methods=['POST'])
def add_team_member():
...
@team_test_bp.route('/api/v1/team_test/members', methods=['DELETE'])
...
@team_test_bp.route('/api/v1/team_test/info', methods=['GET'])
def get_team_info():
...
@team_test_bp.route('/api/v1/team_test/upgrade', methods=['POST'])
