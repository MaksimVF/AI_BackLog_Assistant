...
def test_team_api():
    ...
    with app.app_context():
        ...
        with app.test_client() as client:
            ...
            response = client.get(f'/api/v1/team/members/info?org_id={org_id}')
            print(f"Initial team info response: {response.status_code}")
            print(f"Initial team info data: {response.get_data(as_text=True)}")

            # Add team member
            response = client.post(f'/api/v1/team/members/add?org_id={org_id}')
            print(f"Add team member response: {response.status_code}")
            print(f"Response data: {response.get_data(as_text=True)}")

            # Get team info after adding one member
            response = client.get(f'/api/v1/team/members/info?org_id={org_id}')
            print(f"Team info after adding one member response: {response.status_code}")
            print(f"Team info after adding one member data: {response.get_data(as_text=True)}")
            ...
            response = client.get(f'/api/v1/team/members/info?org_id={org_id}')
            print(f"Team info after adding two members response: {response.status_code}")
            print(f"Team info after adding two members data: {response.get_data(as_text=True)}")
            ...
            response = client.get(f'/api/v1/team/members/info?org_id={org_id}')
            print(f"Team info after trying to add third member response: {response.status_code}")
            print(f"Team info after trying to add third member data: {response.get_data(as_text=True)}")

            # Remove team member
            response = client.post(f'/api/v1/team/members/remove?org_id={org_id}')
            print(f"Remove team member response: {response.status_code}")
            print(f"Response data: {response.get_data(as_text=True)}")

            # Get team info after removing one member
            response = client.get(f'/api/v1/team/members/info?org_id={org_id}')
            print(f"Team info after removing one member response: {response.status_code}")
            print(f"Team info after removing one member data: {response.get_data(as_text=True)}")
