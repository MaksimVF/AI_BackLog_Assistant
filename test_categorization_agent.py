...
def test_categorization_agent():
    ...
    result = categorizer.categorize_document(contract_text)
    ...
    result = categorizer.categorize_document(invoice_text)
    ...
    result = categorizer.categorize_document(medical_text)
    ...
    result = categorizer.categorize_document(tech_text)
