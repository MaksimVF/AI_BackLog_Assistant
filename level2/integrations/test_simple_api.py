...
"""
Simple test script for integration API endpoints.
"""
...
from api.integration_dto import IntegrationConfig, IntegrationStatus, SyncRequest, CreateExternalTaskRequest, JiraConfig, TrelloConfig
...
def test_integration_dto():
    ...
    # Test Trello config
    trello_config = IntegrationConfig(
        service="trello",
        api_key="test_key",
        api_token="test_token",
        board_id="test_board"
