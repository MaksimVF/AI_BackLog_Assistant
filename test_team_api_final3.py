...
def test_team_api():
    ...
    with app.app_context():
        ...
        with app.test_client() as client:
            ...
            response = client.get(f'/api/v1/team_test/info?org_id={org_id}')
            print(f"Initial team info response: {response.status_code}")
            print(f"Initial team info data: {response.get_data(as_text=True)}")

            # Add team member
            response = client.post(f'/api/v1/team_test/members?org_id={org_id}')
            ...
            # Remove team member
            response = client.delete(f'/api/v1/team_test/members?org_id={org_id}')
